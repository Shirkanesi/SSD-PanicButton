...
#define LED_STEP    50        //The step of LED-Fade
...
#define BUZZ_FREQ   1         //This value multiplyed with BREAK_LEN is the time-distance (in mSeconds) between buzzer-beeps [/1000 is in Seconds :P]
